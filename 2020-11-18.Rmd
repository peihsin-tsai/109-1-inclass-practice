...
```{r ans11}
category.factor <- factor(c("新登場","推薦套餐","豪華雙饗丼","牛丼類","咖哩類","豬肉丼類"))
newPromotion1 <- list(
 category   = category.factor[1],
 item       =  "番茄牛丼",
...
```{r ans12}
recommend1 <- list(
 category   = category.factor[4],
 item       =  "蔥溫玉牛丼",
 description ="【元祖】滿滿香脆的青蔥配上微辣的韓國辣醬，口味獨特，是SUKIYA的大人氣商品，非嚐不可",
 price     = 109.00
)
```
